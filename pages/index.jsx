            ...
            <div className="container-fluid">
                ...
                <section className="home-service row bg-[#18191D]">
                    ...
                    <div className="col-sm-6 home-service-right">
                        There are many variations of passages of available but majority alteration in some form, by
                        humou or randomised words.
                    </div>
                </section>
                <section className="home-marketing row">
                    <div className="row d-flex justify-content-between">
                        <ServicesCard />
                    </div>
                </section>
                <section className="home-solution row">
                    <div className="col-md-12 col-lg-6 col-12 home-solution-content">
                        ...
                        <div className="home-solution-content-heading">
                            ...
                            <p className="home-solution-des">
                                ...
                                alteration in some form, by injected hum randomised words which do not slightly.
                            </p>
                        </div>
                            ...
                            <div className="home-solution-item">
                                ...
                                <div>
                                    ...
                                    <div className="home-solution-item-text">
                                        Knowledge of technologies rules better than anyone which we apply in our daily
                                        work
                                    </div>
                                </div>
                            </div>
                ...
                <section className={`home-business row ${isVisible ? 'animate__animated animate__fadeInLeft' : ''}`}>
                    ...
                    <div className="col-md-12 col-lg-6 col-12" style={{ marginTop: '30px' }}>
                ...
                <section className="home-talking row home-talking-bg">
                    <div className="col-sm-6 col-12 home-talking-left">
                    ...
                    <div className="col-sm-6 col-12 home-talking-right d-flex">
                ...
                <section className="home-agency">
                    ...
                    <div className="home-agency-content row">
                    ...
                    <div className="row home-agency-qc">
                        <div className="home-agency-qc--group">
                            <div className="home-agency-qc--item col-sm-4 col-12">
                                <span>
                ...
                <section className="home-statist">
                    <div className="home-statist-counter row">
                        <div className="home-statist-item col-12 col-sm-3">
                ...
                <section className="home-together home-together-bg">
                    ...
                    <div className="row ">
                        <div className="col-10 col-lg-8 col-md-10 home-together-form">
